...
<div id="page" class="hfeed site">
	...
	<?php if ( get_header_image() && $himage == '' ) : ?>
		...
		<?php if ( (get_theme_mod('moesia_banner') == 1 && is_front_page()) ||  (get_theme_mod('moesia_banner') != 1)) : ?>
			...
			<?php endif; ?>
			<div class="welcome-info" id="welcome-info-custom">
				...
				<?php elseif ( get_theme_mod('header_title') ) : ?>
					<div class="welcome-title wow bounceInDown" id="welcome-title-custom"><?php echo esc_attr(get_theme_mod('header_title')); ?></div>
				<?php endif; ?>
				...
				<?php if (get_theme_mod('header_btn_text') && get_theme_mod('header_btn_link')) : ?>
					<a href="<?php echo esc_url(get_theme_mod('header_btn_link')); ?>" id="welcome-button-custom" class="welcome-button wow bounceInUp" data-wow-delay="0.3s"><?php echo esc_html(get_theme_mod('header_btn_text')); ?></a>
				<?php endif; ?>
			</div>
		<?php endif; ?>
	...
	<?php elseif ( $himage != '' ) : ?>	
		<header id="masthead" class="site-header has-banner" role="banner">
			...
			<div class="welcome-info" id="welcome-info-custom">
				...
				<?php elseif ( $htitle ) : ?>
					<div class="welcome-title wow bounceInDown" id="welcome-title-custom"><?php echo esc_html($htitle); ?></div>
				<?php endif; ?>
				...
				<?php if ($hbutton && $hlink) : ?>
					<a href="<?php echo esc_url($hlink); ?>" id="welcome-button-custom" class="welcome-button wow bounceInUp" data-wow-delay="0.3s"><?php echo esc_html($hbutton); ?></a>
				<?php endif; ?>
			</div>
			<?php tha_header_bottom(); ?>			
		</header><!-- #masthead -->	
