...
class fortune_testimonial extends WP_Widget {

// constructor
    function fortune_testimonial() {
		$widget_ops = array('classname' => 'moesia_testimonials_widget', 'description' => __( 'Display testimonials from your clients.', 'moesia') );
        parent::WP_Widget(false, $name = __('Moesia FP: Testimonials custom', 'moesia'), $widget_ops);
		...
		<section id="testimonials" class="testimonials-area">
			<div class="container">
				...
				<?php while ( $r->have_posts() ) : $r->the_post(); ?>
					...
					<div class="testimonial col-md-6 col-sm-12 fadeInUp">
						<div class="testimonial-body-custom"><?php the_content(); ?></div>						
						<div class="customer-info col-xs-12">
							<span class="customer-title"><?php the_title(); ?></span>
						<?php if ($function != '') : ?>
				...
				<div class="fortune-rating col-sm-12">
					<div class="stars">
					...
					<div class="rating-logos">
						<div id="TA_certificateOfExcellence934" class="TA_certificateOfExcellence">
							<ul id="2r4urT2kjD" class="TA_links 3ysqpdyS9">
								<li id="jKL9DXvTMMT" class="bSmCFHYn">
								<a target="_blank" href="http://www.tripadvisor.com/Hotel_Review-g294197-d4136389-Reviews-Fortune_Downtown_Hostel-Seoul.html"><img src="http://www.tripadvisor.com/img/cdsi/img2/awards/CoE2015_WidgetAsset-14348-2.png" alt="TripAdvisor" class="widCOEImg" id="CDSWIDCOELOGO"/></a>
								</li>
							</ul>
						</div>
						<script src="http://www.jscache.com/wejs?wtype=certificateOfExcellence&amp;uniq=934&amp;locationId=4136389&amp;lang=en_US&amp;year=2015&amp;display_version=2"></script>
					</div>
				</div>
