...
class project_rooms extends WP_Widget {

// constructor
    function project_rooms() {
		$widget_ops = array('classname' => 'moesia_projects_widget', 'description' => __( 'Show your most intresting projects.', 'moesia') );
        parent::WP_Widget(false, $name = __('Moesia FP: Projects Custom', 'moesia'), $widget_ops);
				...
				<?php while ( $r->have_posts() ) : $r->the_post(); ?>
					...
					<div class="project col-md-4 col-sm-6 col-xs-6 wow zoomIn">
						<div class="project-image">
							...
							<div class="room-bottom-line-container">
								<div class="room-bottom-line"></div>
							</div>
							<div class="room-price"><?php echo ($video_url); ?></div>
							<div class="room-view-container">
								<a class="room-view" href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">VIEW</a>
							</div>
